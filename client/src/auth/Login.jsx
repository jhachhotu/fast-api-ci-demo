    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 px-4 py-8">
      <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-4 sm:space-y-6">
          ...
          {error && <p className="text-red-500 text-xs sm:text-sm text-center bg-red-50 py-2 rounded-lg">{error}</p>}

          <button type="submit" className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-2 sm:py-3 rounded-lg font-semibold hover:shadow-lg hover:-translate-y-0.5 transition-all text-sm sm:text-base">
            Login
          </button>
        </form>
